...
/*
* sys_enter_mkdir, sys_enter_readlink, and sys_enter_unlink do not exist on arm64
* they are replaced with sys_enter_mkdirat, sys_enter_readlinkat, sys_enter_unlinkat
* sys_enter_fork also does not exist and there is no alternative so it is included but not monitored
*
* the names of the tracepoint and ebpf program names are shared between amd64 and arm64 to reduce code
* as the have the same functionality
 */

package types

const (
	Sys_enter_mkdir = "sys_enter_mkdirat" //tracepoint
	Handle_mkdir    = "handle_mkdirat"    //ebpf program name
	...
	Sys_enter_readlink = "sys_enter_readlinkat"
	Handle_readlink    = "handle_readlinkat"

	Sys_enter_unlink = "sys_enter_unlinkat"
	Handle_unlink    = "handle_unlinkat"
